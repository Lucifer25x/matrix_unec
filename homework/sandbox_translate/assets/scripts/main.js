...
const data = {
  en: {
    navbar: ["Demos", "Pages", "Projects", "Blog", "Blocks", "Documentation"],
    main: [
    ...
    why: [
      ...
      ["Collect Ideas", "Data Analysis", "Finalize Product"],
    ],
  ...
  az: {
    ...
    why: [
      ...
      ["İdeyaları Toplama", "Data Analizi", "Produktu Yekunlaşdırma"],
    ],
...
function changeLang(lang) {
  ...
  document.querySelector(".projects_title").textContent =
    translatedData.projects[0];
  document.querySelector(".projects_desc").textContent =
    translatedData.projects[1];
